    ...
    <>
      <style>{`
        ...
        .portfolio-overlay {
          position: absolute;
          inset: 0;
          background: linear-gradient(to top, rgba(31,30,31,0.85) 0%, transparent 55%);
          opacity: 0;
        ...
        .portfolio-overlay-tag {
          ...
          border-radius: 100vw;
          border: 1px solid rgba(186,198,255,0.35);
        }
      ...
      <section className="portfolio-hero">
        ...
        <p className="portfolio-hero-sub">
          Every property tells a story. We make sure it&apos;s a great one.
        </p>
      </section>
